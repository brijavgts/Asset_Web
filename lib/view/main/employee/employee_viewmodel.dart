...
class EmployeeViewModel extends VGTSBaseViewModel {
  ...
  List<Emplopyee> employes=[
    Emplopyee(name: "Brija", dept: "Mobile", asset: "Mac", worth: "\$1000000", profile: Images.appLogo),
    Emplopyee(name: "Brija", dept: "Mobile", asset: "Mac", worth: "\$1000000", profile: Images.appLogo,),
    Emplopyee(name: "Brija", dept: "Store", asset: "Mac", worth: "\$1000000", profile:Images.appLogo),
    Emplopyee(name: "Brija", dept: "Mobile", asset: "Mac", worth: "\$1000000", profile:Images.appLogo),
  ];
  ...
  List<DataRow> getRows (List<Emplopyee> employes) => employes
      ...
      cells: [
        DataCell(Row(
          children: [
            CircleAvatar(backgroundImage: AssetImage(employe.profile),radius: 15,),
            SizedBox(width: 8,),
